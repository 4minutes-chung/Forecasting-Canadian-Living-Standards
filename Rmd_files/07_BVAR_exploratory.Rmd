...
librarian::shelf(readr, dplyr, lubridate, tidyr, BVAR, here)


df <- readr::read_csv(here::here("data/raw/balanced_can_md.csv"), show_col_types = FALSE) |>
  dplyr::mutate(
    Date      = as.Date(Date),
...
readr::write_csv(bvar_rmse_by_var, here::here("outputs/forecasts/bvar_rmse_by_var.csv"))
...
readr::write_csv(bvar_summary, here::here("outputs/forecasts/bvar_holdout_summary.csv"))
