...
R_packages <- c("readr", "dplyr", "tseries", "vars", "ggplot2", "lubridate", "scales", "tsDyn", "xts", "zoo", "tidyverse", "here")
...
# 1. Data
```{r}
df <- read_csv(here::here("data/raw/balanced_can_md.csv"), show_col_types = FALSE)
...
write.csv(var_large_short_long,
          here::here("outputs/forecasts/VAR_large_all_variables_short.csv"),
          row.names = FALSE)

write.csv(var_large_long_long,
          here::here("outputs/forecasts/VAR_large_all_variables_long.csv"),
          row.names = FALSE)
```
