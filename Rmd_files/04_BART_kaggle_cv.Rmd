...
---
**Note**: This file was originally run on Kaggle. Paths updated for local use; full BART CV takes ~3hr locally.
...
# Load data from local path (previously from /kaggle/input/dataset/)
...
write.csv(short_term_bart_table, here::here("outputs/forecasts/bart_short.csv"), row.names = FALSE)
write.csv(long_term_bart_table, here::here("outputs/forecasts/bart_long.csv"), row.names = FALSE)
