...
R_packages <- c("readr", "dplyr", "tidyr", "tibble",
                "ggplot2", "lubridate", "knitr", "zoo", "here")
...
var_short <- read_csv(here::here("outputs/forecasts/VAR_large_all_variables_short.csv"), show_col_types = FALSE) |>
  mutate(model = "VAR", horizon_group = "short")

var_long  <- read_csv(here::here("outputs/forecasts/VAR_large_all_variables_long.csv"),  show_col_types = FALSE) |>
  mutate(model = "VAR", horizon_group = "long")


rf_short <- read_csv(here::here("outputs/forecasts/RF_all_variables_short.csv"), show_col_types = FALSE) |>
  mutate(model = "Random Forest", horizon_group = "short")

rf_long  <- read_csv(here::here("outputs/forecasts/RF_all_variables_long.csv"),  show_col_types = FALSE) |>
  mutate(model = "Random Forest", horizon_group = "long")


bart_short <- read_csv(here::here("outputs/forecasts/BART_all_variables_short.csv"), show_col_types = FALSE) |>
  mutate(model = "BART", horizon_group = "short")

bart_long  <- read_csv(here::here("outputs/forecasts/BART_all_variables_long.csv"),  show_col_types = FALSE) |>
...
data_full <- read.csv(here::here("data/raw/balanced_can_md.csv"))
...
write.csv(vars_large_17, here::here("outputs/forecasts/vars_17_large_model.csv"), row.names = FALSE)
